...
export default {
    ...
    return {
      ...
      posts: [
        ...
        },
        {
          id: 3,
          path: 'javascript.png',
          className: ['blog-content flex flex-xl-row-reverse'],
          title: 'JavaScript',
          description: 'My tech stack'
        },
        {
          id: 4,
          path: 'react-js.png',
          className: ['blog-content flex flex-row-reverse'],
          title: 'React.js',
          description: 'My tech stack'
        },
  ...
  methods: {
    ...
    filterArray (itemId, resultItem) {
      return this.posts.map(it => it.id === itemId && it[resultItem]).filter(item => item !== false)[0]
    }
  }
}
</script>
